...
public class NotePad : MonoBehaviour
{
    ...
    [SerializeField] private InventoryObject menu;
    ...
    {
        slot1.GetComponent<SlotManager>().itemInSlot = menu.inventory[0];
        slot1.GetComponent<SlotManager>().updateSlot();

        slot2.GetComponent<SlotManager>().itemInSlot = menu.inventory[1];
        slot2.GetComponent<SlotManager>().updateSlot();

        slot3.GetComponent<SlotManager>().itemInSlot = menu.inventory[2];
